...
liti = [
    # conv1
    to_Conv("conv1d_10", caption="Conv stack 1", s_filter=5, n_filter=8, size="", to=nodes_liti["a"], width=6, height=2, depth=24),
    *alt_colors_block(
        [
    ...
    # conv2
    to_Conv("conv1d_11", caption="Conv stack 2", s_filter=10, n_filter=16, size="", to=nodes_liti["b"], width=12, height=2, depth=6),
    *alt_colors_block(
        [
    ...
    # flatten
    to_Dense("flatten_12", size=16, to=nodes_liti["c"], depth=16, caption="Flatten 1"),

    to_connection_node("flatten_12", nodes_liti["d"]),

    # dense1
    to_Dense(name="dense_13", size="", to=nodes_liti["d"], depth=32, caption=""),
    *alt_colors_block(
        [
    ...
    # dense2
    to_Dense(name="dense_14", size="", to=nodes_liti["e"], depth=8, caption="Dense stack 2"),
    *alt_colors_block(
        [
...
spec = [
    # conv1
    to_Conv("conv1d_5", caption="Conv stack 3", s_filter=5, n_filter=8, size="", to=nodes_spec["a"], width=6, height=2, depth=32),
    *alt_colors_block(
        [
    ...
    # conv2
    to_Conv("conv1d_6", caption="Conv stack 4", s_filter=10, n_filter=16, size="", to=nodes_spec["b"], width=12, height=2, depth=16),
    *alt_colors_block(
        [
    ...
    # flatten
    to_Dense("flatten_7", size=128, to=nodes_spec["c"], depth=48, caption="Flatten 2"),

    to_connection_node("flatten_7", nodes_spec["d"]),

    # dense1
    to_Dense(name="dense_8", size="", to=nodes_spec["d"], depth=32, caption=""),
    *alt_colors_block(
        [
    ...
    # dense2
    to_Dense(name="dense_9", size="", to=nodes_spec["e"], depth=8, caption="Dense stack 4"),
    *alt_colors_block(
        [
...
plus = [
    to_Dense(name="dense_1", size="", to=nodes_plus["a"],  depth=34, caption=""),
    *alt_colors_block(
        [
    ...
    to_Dense(name="dense_2", size="", to=nodes_plus["b"], depth=38, caption=""),
    *alt_colors_block(
        [
    ...
    to_Dense(name="dense_3", size="", to=nodes_plus["c"], depth=38, caption=""),
    *alt_colors_block(
        [
    ...
    to_Dense(name="dense_4", size="", to=nodes_plus["d"], depth=8, caption=""),
    *alt_colors_block(
        [
...
mixg = [
    to_Dense(name="dense_9",      size="",  to=nodes_mixg["a"],       depth=8),
    to_Dense(name="dense_10",     size="",  to="(dense_9-east)",      depth=8, caption="Mixing stack"),
    to_Dense(name="batch_norm_9", size="",  to="(dense_10-east)",     depth=8, color="color1"),
    to_Dense(name="softmax_1",    size="8", to="(batch_norm_9-east)", depth=8, color="forestgreen"),
]
